...
A big part of the features and bug fixes were implemented by Adam Sitnik, a Microsoft employee to meet the enterprise requirements of Microsoft. So yes, Microsoft has made an investment in BenchmarkDotNet and hopefully will continue to do so. 

The release would not be possible without many contributions from amazing community members. So this release is a combined effort. We build BenchmarkDotNet together to make benchmarking .NET code easy and available to everyone for free!
