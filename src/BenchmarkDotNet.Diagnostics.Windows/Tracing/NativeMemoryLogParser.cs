...
namespace BenchmarkDotNet.Diagnostics.Windows.Tracing
{
    ...
    public class NativeMemoryLogParser
    {
            ...
            string programName)
        {
            ...
            {
                (module, function),
                (programName, new Regex(@"BenchmarkDotNet\.Autogenerated\.Runnable_[0-9]+.WorkloadActionNoUnroll\(", RegexOptions.Compiled)),
                (programName, new Regex(@"BenchmarkDotNet\.Autogenerated\.Runnable_[0-9]+.WorkloadActionUnroll\(", RegexOptions.Compiled))
            };
        }
