...
namespace BenchmarkDotNet.Diagnostics.Windows.Configs
{
    public class DisassemblyDiagnoserAttribute : Attribute, IConfigSource
    {
        ...
        public DisassemblyDiagnoserAttribute(bool printAsm = true, bool printIL = false, bool printSource = false, bool printPrologAndEpilog = false)
        {
            Config = ManualConfig.CreateEmpty().With(new DisassemblyDiagnoser(printAsm, printIL, printSource, printPrologAndEpilog));
        }
