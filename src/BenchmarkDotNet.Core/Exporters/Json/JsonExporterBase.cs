    ...
    public abstract class JsonExporterBase : ExporterBase
    {
        ...
        public override void ExportToLog(Summary summary, ILogger logger)
        {
            ...
            var environmentInfo = new
            {
                ...
                summary.HostEnvironmentInfo.LogicalCoresCount,
                PhysicalCoresCount = summary.HostEnvironmentInfo.PhysicalCoresCount.Value,
                PhysicalProcessorsCount = summary.HostEnvironmentInfo.PhysicalProcessorsCount.Value,
