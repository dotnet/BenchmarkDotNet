    ...
    public abstract class JsonExporterBase : ExporterBase
    {
        ...
        public override void ExportToLog(Summary summary, ILogger logger)
        {
            ...
            var environmentInfo = new
            {
                ...
                LogicalCoresCount = summary.HostEnvironmentInfo.LogicalCoreCount,
                PhysicalCoresCount = summary.HostEnvironmentInfo.CpuInfo.Value?.PhysicalCoreCount,
                PhysicalProcessorsCount = summary.HostEnvironmentInfo.CpuInfo.Value?.PhysicalProcessorCount,
