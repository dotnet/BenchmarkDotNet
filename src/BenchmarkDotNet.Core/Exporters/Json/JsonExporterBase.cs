    ...
    public abstract class JsonExporterBase : ExporterBase
    {
        ...
        public override void ExportToLog(Summary summary, ILogger logger)
        {
            ...
            var environmentInfo = new
            {
                ...
                PhysicalCoresCount = summary.HostEnvironmentInfo.PhysicalCoreCount.Value,
                PhysicalProcessorsCount = summary.HostEnvironmentInfo.PhysicalProcessorCount.Value,
