...
namespace BenchmarkDotNet.Helpers
{
    public static class ExternalToolsHelper
    {
        ...
        /// Windows only.
        /// </summary>
        public static readonly Lazy<Dictionary<string, string>> Wmic = LazyDic(() => ServicesProvider.RuntimeInformation.IsWindows, "wmic", "cpu list full", '=');

        /// <summary>
        /// Output of the `cat /proc/info` command.
        /// Linux only.
        /// </summary>
        public static readonly Lazy<Dictionary<string, string>> ProcCpuInfo = LazyDic(() => ServicesProvider.RuntimeInformation.IsLinux, "cat", "/proc/cpuinfo", ':');

        /// <summary>
        /// Output of the `lsb_release -a` command.
        /// Linux only.
        /// </summary>
        public static readonly Lazy<Dictionary<string, string>> LsbRelease = LazyDic(() => ServicesProvider.RuntimeInformation.IsLinux, "lsb_release", "-a", ':');

        /// <summary>
        /// Output of the `sysctl -a` command.
        /// MacOSX only.
        /// </summary>
        public static readonly Lazy<Dictionary<string, string>> Sysctl = LazyDic(() => ServicesProvider.RuntimeInformation.IsMac, "sysctl", "-a", ':');
