...
namespace BenchmarkDotNet.Diagnosers
{
    ...
    public static class DisassemblyDiagnoser
    {
        public static IDiagnoser Create(DisassemblyDiagnoserConfig config)
            => DiagnosersLoader.GetImplementation<IDisassemblyDiagnoser, DisassemblyDiagnoserConfig>(config);
    }
}