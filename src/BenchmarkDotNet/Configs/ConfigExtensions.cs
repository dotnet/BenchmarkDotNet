...
namespace BenchmarkDotNet.Configs
{
    public static class ConfigExtensions
    {
        ...
        [PublicAPI] public static IConfig With(this IConfig config, IOrderer orderer) => WithOrderer(config, orderer);
        ...
        [PublicAPI] public static ManualConfig GroupBenchmarksBy(this IConfig config, params BenchmarkLogicalGroupRule[] rules) => config.With(c => c.GroupBenchmarksBy(rules));
