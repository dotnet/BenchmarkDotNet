...
namespace BenchmarkDotNet.Toolchains.InProcess.Emit.Implementation
{
    ...
    internal class RunnableEmitter
    {
        ...
        {
            // .method public hidebysig 
            //    instance int32 __ForDisassemblyDiagnoser__() cil managed noinlining
            ...
            methodBuilder.SetNoInliningImplementationFlag();
        ...
        private MethodBuilder EmitRunMethod()
        {
            ...
            /*
                .method public hidebysig static 
                    void Run (
                        ...
                        class [BenchmarkDotNet]BenchmarkDotNet.Configs.IConfig config,
            ...
            var configArg = argsExceptInstance[1];
            var hostArg = argsExceptInstance[2];
            ...
            /*
                // (Job, EngineParameters, IEngineFactory) valueTuple = RunnableReuse.PrepareForRun(instance, benchmarkCase, config, host);
                IL_0006: ldloc.0
                IL_0007: ldarg.0
                IL_0008: ldarg.1
                IL_0009: ldarg.2
                IL_000a: call valuetype [mscorlib]System.ValueTuple`3<class [BenchmarkDotNet]BenchmarkDotNet.Jobs.Job, class [BenchmarkDotNet]BenchmarkDotNet.Engines.EngineParameters, class [BenchmarkDotNet]BenchmarkDotNet.Engines.IEngineFactory> [BenchmarkDotNet]BenchmarkDotNet.Toolchains.InProcess.Emit.Implementation.RunnableReuse::PrepareForRun<class BenchmarkDotNet.Autogenerated.Runnable_0>(!!0, class [BenchmarkDotNet]BenchmarkDotNet.Running.BenchmarkCase, class [BenchmarkDotNet]BenchmarkDotNet.Configs.IConfig, class [BenchmarkDotNet]BenchmarkDotNet.Engines.IHost)
             */
            ilBuilder.EmitLdloc(instanceLocal);
            ilBuilder.EmitLdarg(benchmarkCaseArg);
            ilBuilder.EmitLdarg(configArg);
            ...
            /*
                ...
                IL_000f: dup
                IL_0010: ldfld !0 valuetype [mscorlib]System.ValueTuple`3<class [BenchmarkDotNet]BenchmarkDotNet.Jobs.Job, class [BenchmarkDotNet]BenchmarkDotNet.Engines.EngineParameters, class [BenchmarkDotNet]BenchmarkDotNet.Engines.IEngineFactory>::Item1
                IL_0015: stloc.1
             */
            ...
            /*
                ...
                IL_0016: dup
                IL_0017: ldfld !1 valuetype [mscorlib]System.ValueTuple`3<class [BenchmarkDotNet]BenchmarkDotNet.Jobs.Job, class [BenchmarkDotNet]BenchmarkDotNet.Engines.EngineParameters, class [BenchmarkDotNet]BenchmarkDotNet.Engines.IEngineFactory>::Item2
                IL_001c: stloc.2
             */
            ilBuilder.Emit(OpCodes.Dup);
            ...
            /*
                ...
                IL_001d: ldfld !2 valuetype [mscorlib]System.ValueTuple`3<class [BenchmarkDotNet]BenchmarkDotNet.Jobs.Job, class [BenchmarkDotNet]BenchmarkDotNet.Engines.EngineParameters, class [BenchmarkDotNet]BenchmarkDotNet.Engines.IEngineFactory>::Item3
                IL_0022: stloc.3
             */
            ...
            ilBuilder.BeginExceptionBlock();
            {
                ...
                /*
                    ...
                    IL_0041: ldloc.0
                    IL_0042: callvirt instance void BenchmarkDotNet.Autogenerated.Runnable_0::__TrickTheJIT__()
                 */
