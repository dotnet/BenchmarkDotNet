...
namespace BenchmarkDotNet.Toolchains.CoreRt
{
    public class CoreRtToolchainBuilder : CustomDotNetCliToolchainBuilder
    {
        ...
        /// Based on https://github.com/dotnet/corert/tree/master/samples/HelloWorld#add-corert-to-your-project
        /// </summary>
        ...
        /// Based on https://github.com/dotnet/corert/blob/master/Documentation/how-to-build-and-run-ilcompiler-in-console-shell-prompt.md#compiling-source-to-native-code-using-the-ilcompiler-you-built
        /// </summary>
        ...
        /// Based on https://github.com/dotnet/corert/blob/master/Documentation/how-to-build-and-run-ilcompiler-in-console-shell-prompt.md#using-cpp-code-generator
        /// </summary>
