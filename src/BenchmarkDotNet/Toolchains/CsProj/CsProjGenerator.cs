...
namespace BenchmarkDotNet.Toolchains.CsProj
{
    ...
    public class CsProjGenerator : DotNetCliGenerator, IEquatable<CsProjGenerator>
    {
        ...
        private static readonly ImmutableArray<string> SettingsWeWantToCopy =
            new[] { "NetCoreAppImplicitPackageVersion", "RuntimeFrameworkVersion", "PackageTargetFallback", "LangVersion", "UseWpf", "UseWindowsForms", "CopyLocalLockFileAssemblies", "PreserveCompilationContext", "UserSecretsId", "EnablePreviewFeatures", "EnablePreviewFeatures" }.ToImmutableArray();
