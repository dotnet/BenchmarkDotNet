...
namespace BenchmarkDotNet.Toolchains.CsProj
{
    public class CsProjBuilder(DotNetCliSettings settings) : DotNetCliBuilder(settings)
    {
        ...
        protected override string GetBuildArtifactsDirectoryPath(BuildPartition buildPartition, string programName)
        {
            ...
            return Path.Combine(projectDirectory, ProjectLocalFolderName, programName);
        }
        ...
        // The program sits beside the generated project, so the SDK's default glob compiles it. The build
        // directory is a dot-folder, which every other project's default globs leave out.
        protected override string GetCodeFileExtension() => ".cs";
