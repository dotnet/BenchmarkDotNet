    ...
    internal class RunnableEmitter
    {
        ...
        private void DefineFields()
        {
            ...
            overheadDelegateField =
                runnableBuilder.DefineField(OverheadDelegateFieldName, workloadDelegateType, FieldAttributes.Private);
        ...
        {
            var overheadInvokeMethod = TypeBuilderExtensions.GetDelegateInvokeMethod(workloadDelegateType);
            ...
            consumeEmitter.EmitOverheadImplementation(methodBuilder.GetILGenerator(), methodBuilder.ReturnType);
        ...
        private MethodBuilder EmitActionImpl(string methodName, RunnableActionKind actionKind, int unrollFactor)
        {
            ...
            consumeEmitter.DeclareLoopLocals(ilBuilder);
            {
                /*
                    // overheadDelegate();
                    IL_0005: ldarg.0
