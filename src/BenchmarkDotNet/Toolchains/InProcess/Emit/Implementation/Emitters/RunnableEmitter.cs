...
namespace BenchmarkDotNet.Toolchains.InProcess.Emit.Implementation
{
    ...
    internal abstract partial class RunnableEmitter
    {
        ...
        private void EmitTrickTheJit()
        {
            ...
            /*
                // __ForDisassemblyDiagnoser__(new Random(123).Next(0, 10));
                IL_0000: ldarg.0
                ...
                IL_0010: call instance void BenchmarkDotNet.Autogenerated.Runnable_0::__ForDisassemblyDiagnoser__(int32)
             */
        ...
        {
            // .method public hidebysig
            //    instance void __ForDisassemblyDiagnoser__(int32 notEleven) cil managed noinlining nooptimization
