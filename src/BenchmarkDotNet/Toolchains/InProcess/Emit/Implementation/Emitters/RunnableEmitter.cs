...
namespace BenchmarkDotNet.Toolchains.InProcess.Emit.Implementation
{
    ...
    internal class RunnableEmitter
    {
        ...
        {
            //.method private hidebysig
            //    instance void __OverheadWrapper(int64 arg0) cil managed noinlining nooptimization
            ...
            /*
                IL_0000: ldarg.0
                IL_0001: ldarg.1
                IL_0002: call instance void [BenchmarkDotNet]BenchmarkDotNet.Samples.SampleBenchmark::__Overhead(int64)
                IL_0007: ret
             */
        ...
        private MethodBuilder EmitWorkloadWrapperImplementation(string methodName)
        {
            ...
            if (consumableInfo.IsAwaitable)
            {
                 ...
                 */
                callResultLocal = ilBuilder.DeclareOptionalLocalForInstanceCall(consumableInfo.OriginMethodReturnType, consumableInfo.GetAwaiterMethod);
                awaiterLocal = ilBuilder.DeclareOptionalLocalForInstanceCall(awaiterType, consumableInfo.GetResultMethod);
            }
        ...
        private MethodBuilder EmitActionImpl(string methodName, RunnableActionKind actionKind, int unrollFactor)
        {
            ...
            ilBuilder.EmitLoopBeginFromLocToArg(loopStartLabel, loopHeadLabel, indexLocal, toArg);
            {
                /*
                    // __OverheadWrapper();
                    IL_0005: ldarg.0
                    IL_000b: call instance void BenchmarkDotNet.Autogenerated.Runnable_0::__OverheadWrapper()
                 */
