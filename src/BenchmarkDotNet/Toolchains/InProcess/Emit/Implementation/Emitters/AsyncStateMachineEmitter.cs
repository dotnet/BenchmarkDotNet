...
partial class RunnableEmitter
{
    ...
    private MethodInfo EmitAsyncCallerStub(string methodName, Type asyncStateMachineType, AsyncStateMachineFields asyncStateMachineFields)
    {
        ...
        */
        ...
        // [AsyncStateMachine(typeof(<GlobalSetup>d__1))]
        ...
        /*
            .locals init (
                [0] valuetype BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'
            )
         */
        ...
        /*
            ...
            IL_0007: stfld valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
         */
        ...
        if (thisField is not null)
        {
            /*
                ...
                IL_000c: ldloca.s 0
                IL_000e: ldarg.0
                IL_000f: stfld class BenchmarkDotNet.Autogenerated.Runnable_0 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>4__this'
             */
            ilBuilder.EmitLdloca(asyncStateMachineLocal);
        ...
        /*
            ...
            IL_0014: ldloca.s 0
            IL_0016: ldc.i4.m1
            IL_0017: stfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
         */
        ilBuilder.EmitLdloca(asyncStateMachineLocal);
        ...
        /*
            ...
            IL_001c: ldloca.s 0
            IL_001e: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
            IL_0023: ldloca.s 0
            IL_0025: call instance void [System.Runtime]System.Runtime.CompilerServices.AsyncTaskMethodBuilder::Start<valuetype BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'>(!!0&)
         */
        ilBuilder.EmitLdloca(asyncStateMachineLocal);
        ...
        if (taskGetMethod != null)
        {
            /*
                ...
                IL_002a: ldloca.s 0
                IL_002c: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
    ...
    private AsyncStateMachineBuilderInfo BeginAsyncStateMachineTypeBuilder(string callerMethodName, Type asyncMethodBuilderType, Type? thisType)
    {
        /*
            ...
            [CompilerGenerated]
            private struct <GlobalSetup>d__1 : IAsyncStateMachine
         */
        // Roslyn generates ordinals in declaration order of every member.
        // We don't necessarily emit members in the same order, so we map it to the expected Roslyn ordinal.
        // The constructor is the runnable's first member; Run lives on Runner_# and so takes no ordinal here.
        // This doesn't really matter for the runtime, but it helps with the NaiveRunnableEmitDiff tests.
        // The fields container is declared last in BenchmarkType.txt precisely so that these are constant: if declared any earlier,
        // its struct and field would shift everything after it by two whenever a benchmark has fields at all.
        int ordinal = callerMethodName switch
        {
            GlobalSetupMethodName => 1,
            GlobalCleanupMethodName => 2,
            IterationSetupMethodName => 3,
            IterationCleanupMethodName => 4,
            OverheadActionUnrollMethodName => 8,
            OverheadActionNoUnrollMethodName => 9,
            WorkloadActionUnrollMethodName => 10,
            WorkloadActionNoUnrollMethodName => 11,
            StartWorkloadMethodName => 12,
            WorkloadCoreMethodName => 13,
            _ => throw new ArgumentOutOfRangeException(nameof(callerMethodName), callerMethodName, "No Roslyn ordinal is known for this method.")
        };
        ...
        AsyncStateMachineMoveNextInfo BeginEmitMoveNext()
        {
            ...
            /*
                // int num = <>1__state;
                IL_0000: ldarg.0
                IL_0001: ldfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
                IL_0006: stloc.0
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ...
            if (thisField is not null)
            {
                /*
                    ...
                    IL_0007: ldarg.0
                    IL_0008: ldfld class BenchmarkDotNet.Autogenerated.Runnable_0 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>4__this'
                    IL_000d: stloc.1
                 */
                ilBuilder.Emit(OpCodes.Ldarg_0);
        ...
        void EmitSetStateMachine()
        {
            ...
            /*
                ...
                IL_0000: ldarg.0
                IL_0001: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
                IL_0006: ldarg.1
    ...
    private Type CompleteAsyncStateMachineType(Type asyncMethodBuilderType, AsyncStateMachineBuilderInfo asyncStateMachineBuilderInfo)
    {
        ...
        ilBuilder.BeginCatchBlock(typeof(Exception));
        {
            ...
            /*
                ...
                IL_006c: ldarg.0
                IL_006d: ldc.i4.s -2
                IL_006f: stfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ...
            /*
                ...
                IL_0074: ldarg.0
                IL_0075: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
                IL_007a: ldloc.3
        ...
        /*
            ...
            IL_0082: ldarg.0
            IL_0083: ldc.i4.s -2
            IL_0085: stfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
         */
        // IL_0082:
        ...
        /*
            ...
            IL_008a: ldarg.0
            IL_008b: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
	        ...
	        IL_018f: ldarg.0
	        IL_0190: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder`1<int32> BenchmarkDotNet.Autogenerated.Runnable_0/'<WorkloadCore>d__14'::'<>t__builder'
	        IL_0195: ldloc.2
    ...
    private MethodInfo EmitAsyncSingleCall(string methodName, Type asyncMethodBuilderType, MethodInfo methodToCall, SetupCleanupKind kind)
    {
        ...
        void EmitMoveNextImpl()
        {
            ...
            /*
                ...
                IL_0028: dup
                IL_0029: stloc.0
                IL_002a: stfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ...
            /*
                ...
                IL_002f: ldarg.0
                IL_0030: ldloc.2
                IL_0031: stfld valuetype [System.Runtime]System.Runtime.CompilerServices.TaskAwaiter BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>u__1'
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ilBuilder.EmitLdloc(awaiterLocal);
            ...
            /*
                ...
                IL_0036: ldarg.0
                IL_0037: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>t__builder'
                IL_003c: ldloca.s 2
                IL_003e: ldarg.0
                IL_003f: call instance void [System.Runtime]System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder::AwaitUnsafeOnCompleted<valuetype [System.Runtime]System.Runtime.CompilerServices.TaskAwaiter, valuetype BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'>(!!0&, !!1&)
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ilBuilder.Emit(OpCodes.Ldflda, builderField);
            ilBuilder.EmitLdloca(awaiterLocal);
            ...
            /*
                // awaiter = <>u__1;
                IL_0046: ldarg.0
                IL_0047: ldfld valuetype [System.Runtime]System.Runtime.CompilerServices.TaskAwaiter BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>u__1'
                IL_004c: stloc.2
             */
            // IL_0046:
            ...
            /*
                ...
                IL_004d: ldarg.0
                IL_004e: ldflda valuetype [System.Runtime]System.Runtime.CompilerServices.TaskAwaiter BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>u__1'
            ...
            /*
                ...
                IL_005b: dup
                IL_005c: stloc.0
                IL_005d: stfld int32 BenchmarkDotNet.Autogenerated.Runnable_0/'<GlobalSetup>d__1'::'<>1__state'
             */
            ilBuilder.Emit(OpCodes.Ldarg_0);
            ilBuilder.Emit(OpCodes.Ldc_I4_M1);
            ilBuilder.Emit(OpCodes.Dup);
