...
namespace BenchmarkDotNet.Toolchains.DotNetCli
{
    ...
    {
        public static readonly TimeSpan DefaultBuildTimeout = TimeSpan.FromMinutes(10); // it should always be a few seconds, but some users might have a bad internet connection
