    ...
    internal static class DotNetSdkValidator
    {
        ...
        private static string GetSdkVersionFromMoniker(RuntimeMoniker runtimeMoniker)
        {
            return runtimeMoniker switch
            {
                ...
                RuntimeMoniker.Wasm => Portability.RuntimeInformation.IsNetCore ? CoreRuntime.GetCurrentVersion().MsBuildMoniker.Substring(3) : "5.0",
                ...
                RuntimeMoniker.MonoAOTLLVM => Portability.RuntimeInformation.IsNetCore ? CoreRuntime.GetCurrentVersion().MsBuildMoniker.Substring(3) : "6.0",
