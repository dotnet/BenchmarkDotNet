...
namespace BenchmarkDotNet.Diagnosers
{
    public class DisassemblyDiagnoserConfig
    {
        ...
        [PublicAPI] public static readonly DisassemblyDiagnoserConfig All = new DisassemblyDiagnoserConfig(true, true, true, int.MaxValue, true);
        ...
        [PublicAPI]
        public DisassemblyDiagnoserConfig(bool printAsm = true, bool printSource = false, bool printPrologAndEpilog = false,
