...
namespace BenchmarkDotNet.Jobs
{
    public static class JobExtensions
    {
        ...
        /// </summary>
        public static Job WithIterationTime(this Job job, TimeValue time) => job.WithCore(j => j.Run.IterationTime = time);
        ...
        /// </summary>
        public static Job WithMaxAbsoluteError(this Job job, TimeValue value) => job.WithCore(j => j.Accuracy.MaxAbsoluteError = value);
        ...
        /// The default value is 500 milliseconds.
        /// </summary>
        public static Job WithMinIterationTime(this Job job, TimeValue value) => job.WithCore(j => j.Accuracy.MinIterationTime = value);
