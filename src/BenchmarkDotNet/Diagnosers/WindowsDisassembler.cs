    ...
    public class WindowsDisassembler
    {
        ...
        private string BuildArguments(DiagnoserActionParameters parameters, string resultsPath)
            => new StringBuilder(200)
                ...
                .Append(parameters.BenchmarkCase.Descriptor.Kind == BenchmarkKind.Scenario
                    ? DisassemblerConstants.DisassemblerEntryProgramNameForScenarios
                    : $"BenchmarkDotNet.Autogenerated.Runnable_{parameters.BenchmarkId.Value}")
                .Append(' ')
                .Append(parameters.BenchmarkCase.Descriptor.Kind == BenchmarkKind.Scenario 
                    ? DisassemblerConstants.DisassemblerEntryMethodNameForScenarios 
                    : DisassemblerConstants.DisassemblerEntryMethodNameForMicroBenchmarks)
                .Append(' ')
