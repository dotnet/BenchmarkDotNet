        ...
        public PhdEntry ToPhd()
        {
            var entry = new PhdAttributes
            {
                Benchmark = new BdnBenchmark
                {
                    ...
                    MethodTitle = BenchmarkCase.Descriptor.WorkloadMethodDisplayInfo,
                    Parameters = BenchmarkCase.Parameters.PrintInfo,
                    FullName = FullNameProvider.GetBenchmarkName(BenchmarkCase),
            ...
            {
                var measurementsEntry = new PhdAttributes
                {
                ...
                {
                    measurementsEntry.Add(new PhdMetric
                    {
