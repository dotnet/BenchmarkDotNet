...
namespace BenchmarkDotNet.Environments
{
    public class CoreRtRuntime : Runtime
    {
        ...
        /// </summary>
        public static readonly CoreRtRuntime CoreRt20 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt20, "netcoreapp2.0", "CoreRt 2.0");
        /// <summary>
        /// CoreRT compiled as netcoreapp2.1
        /// </summary>
        public static readonly CoreRtRuntime CoreRt21 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt21, "netcoreapp2.1", "CoreRt 2.1");
        /// <summary>
        /// CoreRT compiled as netcoreapp2.2
        /// </summary>
        public static readonly CoreRtRuntime CoreRt22 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt22, "netcoreapp2.2", "CoreRt 2.2");
        /// <summary>
        /// CoreRT compiled as netcoreapp3.0
        /// </summary>
        public static readonly CoreRtRuntime CoreRt30 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt30, "netcoreapp3.0", "CoreRt 3.0");
        /// <summary>
        /// CoreRT compiled as netcoreapp3.1
        /// </summary>
        public static readonly CoreRtRuntime CoreRt31 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt31, "netcoreapp3.1", "CoreRt 3.1");
        /// <summary>
        /// CoreRT compiled as netcoreapp5.0
        /// </summary>
        public static readonly CoreRtRuntime CoreRt50 = new CoreRtRuntime(TargetFrameworkMoniker.CoreRt50, "netcoreapp5.0", "CoreRt 5.0");

        private CoreRtRuntime(TargetFrameworkMoniker targetFrameworkMoniker, string msBuildMoniker, string displayName)
        ...
        internal static CoreRtRuntime GetCurrentVersion()
        {
            ...
            switch (msBuildMoniker)
            {
                ...
                default: // support future version of CoreRT
                    return new CoreRtRuntime(TargetFrameworkMoniker.NotRecognized, msBuildMoniker, displayName);
            }
        }
    }
}
