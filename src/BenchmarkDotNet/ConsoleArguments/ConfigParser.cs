    ...
    public static class ConfigParser
    {
        ...
        private static IConfig CreateConfig(CommandLineOptions options, IConfig globalConfig)
        {
            ...
            if (options.UseDisassemblyDiagnoser)
                config.AddDiagnoser(DisassemblyDiagnoser.Create(new DisassemblyDiagnoserConfig(recursiveDepth: options.DisassemblerRecursiveDepth, printDiff: options.DisassemblerDiff)));
