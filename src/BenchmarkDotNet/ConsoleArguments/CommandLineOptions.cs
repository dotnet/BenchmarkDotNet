...
namespace BenchmarkDotNet.ConsoleArguments
{
    ...
    public class CommandLineOptions
    {
        ...
        [Option("cleanCache", Required = false, Default = false, HelpText = "Run test with clean CPU cache.")]
        public bool RunWithCleanCache { get; set; }
        ...
        public static IEnumerable<Example> Examples
        {
            get
            {
                ...
                yield return new Example("Run benchmarks with clean CPU cache", longName, new CommandLineOptions { RunWithCleanCache = true });
            }
        }
