...
namespace BenchmarkDotNet.ConsoleArguments
{
    ...
    public class CommandLineOptions
    {
        ...
        [Option("customRuntimePack", Required = false, HelpText = "Specify the path to a custom runtime pack. Only used for wasm/MonoAotLLVM currently.")]
        public string CustomRuntimePack { get; set; }

        [Option("AOTCompilerPath", Required = false, HelpText = "Specify the path for the AOT compiler, used for MonoAotLLVM.")]
        public FileInfo AOTCompilerPath { get; set; }

        [Option("AOTCompilerMode", Required = false, Default = MonoAotCompilerMode.mini, HelpText = "Specify the AOT compiler mode for the mono AOT compiler, either 'mini' or 'llvm'")]
