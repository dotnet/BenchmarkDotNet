...
namespace BenchmarkDotNet.ConsoleArguments
{
    ...
    public class CommandLineOptions
    {
        ...
        {
            AllowMultipleArgumentsPerToken = true,
            Description = "GitHub/StackOverflow/RPlot/CSV/JSON/HTML/XML/CSVMeasurements/Markdown/Atlassian/Plain/BriefJSON/FullJSON/Asciidoc/BriefXML/FullXML/OpenMetrics. A custom IExporter can also be selected by its assembly-qualified type name, e.g. \"My.Namespace.MyExporter, MyAssembly\".",
        };
