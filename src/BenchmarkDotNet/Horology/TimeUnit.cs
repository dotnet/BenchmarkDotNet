...
namespace BenchmarkDotNet.Horology
{
    public class TimeUnit
    {
        ...
        public static readonly TimeUnit Nanosecond = new TimeUnit(new MultiEncodingString("ns", "ns"), "Nanosecond", 1);
        public static readonly TimeUnit Microsecond = new TimeUnit(new MultiEncodingString("\u03BCs", "us"), "Microsecond", 1000);
        public static readonly TimeUnit Millisecond = new TimeUnit(new MultiEncodingString("ms", "ms"), "Millisecond", 1000 * 1000);
        public static readonly TimeUnit Second = new TimeUnit(new MultiEncodingString("s", "s"), "Second", 1000 * 1000 * 1000);
        public static readonly TimeUnit Minute = new TimeUnit(new MultiEncodingString("m", "m"), "Minute", Second.NanosecondAmount * 60);
        public static readonly TimeUnit Hour = new TimeUnit(new MultiEncodingString("h", "h"), "Hour", Minute.NanosecondAmount * 60);
        public static readonly TimeUnit Day = new TimeUnit(new MultiEncodingString("d", "d"), "Day", Hour.NanosecondAmount * 24);
