...
namespace BenchmarkDotNet.Horology
{
    public struct TimeInterval
    {
        ...
        public TimeInterval(double nanoseconds, Encoding encoding = null)
        {
            Nanoseconds = nanoseconds;
            this.encoding = encoding ?? Encoding.ASCII;
        } 

        public TimeInterval(double value, TimeUnit unit, Encoding encoding = null) : this(value * unit.NanosecondAmount, encoding) { }
        ...
        [Pure] public static TimeInterval operator /(TimeInterval a, double k) => new TimeInterval(a.Nanoseconds / k, a.encoding);
        [Pure] public static TimeInterval operator /(TimeInterval a, int k) => new TimeInterval(a.Nanoseconds / k, a.encoding);
        [Pure] public static TimeInterval operator *(TimeInterval a, double k) => new TimeInterval(a.Nanoseconds * k, a.encoding);
        [Pure] public static TimeInterval operator *(TimeInterval a, int k) => new TimeInterval(a.Nanoseconds * k, a.encoding);
        [Pure] public static TimeInterval operator *(double k, TimeInterval a) => new TimeInterval(a.Nanoseconds * k, a.encoding);
        ...
        [Pure] public override string ToString() => Nanoseconds.ToTimeStr(encoding: encoding ?? Encoding.ASCII);
    }
}