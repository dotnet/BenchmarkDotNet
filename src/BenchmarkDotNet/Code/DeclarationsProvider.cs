...
namespace BenchmarkDotNet.Code
{
    internal abstract class DeclarationsProvider
    {
        ...
        public virtual string GetAsyncBenchmarkRunnerTypeName(BenchmarkId id) => null;

        public virtual string GetInitializeAsyncBenchmarkRunnerField(BenchmarkId id) => null;
    ...
    internal class AsyncDeclarationsProvider : DeclarationsProvider
    {
        ...
        public override string GetAsyncBenchmarkRunnerTypeName(BenchmarkId id)
        {
            ...
            return $"BenchmarkDotNet.Engines.AsyncBenchmarkRunner<{runnableName}.WorkloadFunc, {runnableName}.OverheadFunc, {consumerTypeName}, {WorkloadMethodReturnTypeName}, {awaiterTypeName}>";
        }

        public override string GetInitializeAsyncBenchmarkRunnerField(BenchmarkId id)
        {
            string runnableName = GetRunnableName(id);
            return $"__asyncBenchmarkRunner = new {GetAsyncBenchmarkRunnerTypeName(id)}(new {runnableName}.WorkloadFunc(this), new {runnableName}.OverheadFunc(this));";
        }
