...
{
    internal abstract class EngineActualStage(IterationMode iterationMode, long invokeCount, int unrollFactor, FrozenEngineParameters parameters) : EngineStage(IterationStage.Actual, iterationMode, parameters)
    {
        ...
        internal static EngineActualStage GetOverhead(long invokeCount, int unrollFactor, FrozenEngineParameters parameters)
            => new EngineActualStageAuto(IterationMode.Overhead, invokeCount, unrollFactor, parameters);

        internal static EngineActualStage GetWorkload(RunStrategy strategy, long invokeCount, int unrollFactor, FrozenEngineParameters parameters)
        {
    ...
    internal sealed class EngineActualStageAuto : EngineActualStage
    {
        ...
        public EngineActualStageAuto(IterationMode iterationMode, long invokeCount, int unrollFactor, FrozenEngineParameters parameters) : base(iterationMode, invokeCount, unrollFactor, parameters)
        {
    ...
    internal sealed class EngineActualStageSpecific(int maxIterationCount, IterationMode iterationMode, long invokeCount, int unrollFactor, FrozenEngineParameters parameters)
