...
namespace BenchmarkDotNet.Engines
{
    ...
    internal abstract class EnginePilotStage(FrozenEngineParameters parameters, long invokeCount, int unrollFactor, int minInvokeCount) : EngineStage(IterationStage.Pilot, IterationMode.Workload, parameters)
    {
        ...
        internal static EnginePilotStage GetStage(FrozenEngineParameters parameters, long invokeCount, int unrollFactor, int minInvokeCount)
            // Here we want to guess "perfect" amount of invocation
            => parameters.TargetJob.HasValue(RunMode.IterationTimeCharacteristic)
                ? new EnginePilotStageSpecific(parameters, invokeCount, unrollFactor, minInvokeCount)
                : new EnginePilotStageAuto(parameters, invokeCount, unrollFactor, minInvokeCount);
    ...
    internal sealed class EnginePilotAfterJitStage(FrozenEngineParameters parameters, long invokeCount, int unrollFactor, int minInvokeCount) : EnginePilotStage(parameters, invokeCount, unrollFactor, minInvokeCount)
    {
    ...
    internal sealed class EnginePilotStageAuto(FrozenEngineParameters parameters, long invokeCount, int unrollFactor, int minInvokeCount) : EnginePilotStage(parameters, invokeCount, unrollFactor, minInvokeCount)
    {
    ...
    internal sealed class EnginePilotStageSpecific(FrozenEngineParameters parameters, long invokeCount, int unrollFactor, int minInvokeCount) : EnginePilotStage(parameters, invokeCount, unrollFactor, minInvokeCount)
    {
