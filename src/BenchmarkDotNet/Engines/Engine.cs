...
namespace BenchmarkDotNet.Engines
{
    ...
    {
        public FrozenEngineParameters Parameters { get; }
        ...
        {
            Parameters = engineParameters?.Freeze()
                ?? throw new ArgumentNullException(nameof(engineParameters));

            if (Parameters.WorkloadActionNoUnroll == null)
                throw new ArgumentNullException(nameof(Parameters.WorkloadActionNoUnroll));
            if (Parameters.WorkloadActionUnroll == null)
                throw new ArgumentNullException(nameof(Parameters.WorkloadActionUnroll));
            if (Parameters.Dummy1Action == null)
                throw new ArgumentNullException(nameof(Parameters.Dummy1Action));
            if (Parameters.Dummy2Action == null)
                throw new ArgumentNullException(nameof(Parameters.Dummy2Action));
            if (Parameters.Dummy3Action == null)
                throw new ArgumentNullException(nameof(Parameters.Dummy3Action));
            if (Parameters.OverheadActionNoUnroll == null)
                throw new ArgumentNullException(nameof(Parameters.OverheadActionNoUnroll));
            if (Parameters.OverheadActionUnroll == null)
                throw new ArgumentNullException(nameof(Parameters.OverheadActionUnroll));
            if (Parameters.TargetJob == null)
                throw new ArgumentNullException(nameof(Parameters.TargetJob));
            if (Parameters.GlobalSetupAction == null)
                throw new ArgumentNullException(nameof(Parameters.GlobalSetupAction));
            if (Parameters.GlobalCleanupAction == null)
                throw new ArgumentNullException(nameof(Parameters.GlobalCleanupAction));
            if (Parameters.IterationSetupAction == null)
                throw new ArgumentNullException(nameof(Parameters.IterationSetupAction));
            if (Parameters.IterationCleanupAction == null)
                throw new ArgumentNullException(nameof(Parameters.IterationCleanupAction));

            Clock = Parameters.TargetJob.ResolveValue(InfrastructureMode.ClockCharacteristic, Resolver);
            ForceGcCleanups = Parameters.TargetJob.ResolveValue(GcMode.ForceCharacteristic, Resolver);
            MemoryRandomization = Parameters.TargetJob.ResolveValue(RunMode.MemoryRandomizationCharacteristic, Resolver);
        ...
        [MethodImpl(CodeGenHelper.AggressiveOptimizationOption)]
        internal Measurement RunIteration(IterationData data)
        {
            // Initialization
