...
namespace BenchmarkDotNet.Exporters.Json
{
    public abstract class JsonExporterBase : ExporterBase
    {
        ...
        public override void ExportToLog(Summary summary, ILogger logger)
        {
            ...
            logger.WriteLine(JsonSerializer.SerializeObject(CreateLog(summary)));
        }

        protected virtual IReadOnlyDictionary<string, object> CreateLog(Summary summary)
        {
            ...
            {
                { "Title", summary.Title },
                { "HostEnvironmentInfo", CreateLog(summary.HostEnvironmentInfo) },
                { "Benchmarks", summary.Reports.Select(CreateLog) }
            };
        }

        protected virtual IReadOnlyDictionary<string, object> CreateLog(HostEnvironmentInfo environmentInfo)
        {
        ...
        protected virtual IReadOnlyDictionary<string, object> CreateLog(BenchmarkReport report)
        {
