...
internal static class HardwareIntrinsics
{
    ...
    internal static string GetShortInfo()
    {
        ...
        if (IsX86Avx2Supported)
            return "AVX2";
        if (IsX86AvxSupported)
            return "AVX";
        if (IsX86Sse42Supported)
            return "SSE4.2";
        if (IsX86Sse41Supported)
            return "SSE4.1";
        if (IsX86Ssse3Supported)
            return "SSSE3";
        if (IsX86Sse3Supported)
            return "SSE3";
        if (IsX86Sse2Supported)
            return "SSE2";
        if (IsX86SseSupported)
            return "SSE";
        if (IsX86BaseSupported)
            return "X86Base";
        if (IsArmAdvSimdSupported)
            return "AdvSIMD";
