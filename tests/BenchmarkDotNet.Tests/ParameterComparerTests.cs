...
namespace BenchmarkDotNet.Tests
{
    ...
    {
        private static readonly ParameterDefinition sharedDefinition = new ParameterDefinition("Testing", isStatic: false, isArgument: false, parameterType: typeof(object), 0);
