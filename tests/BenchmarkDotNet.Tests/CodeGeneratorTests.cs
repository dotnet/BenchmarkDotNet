...
namespace BenchmarkDotNet.Tests
{
    public class CodeGeneratorTests
    {
        ...
        public void AsyncVoidIsNotSupported()
        {
            ...
            Assert.Throws<NotSupportedException>(() => CodeGenerator.Generate(new BuildPartition(0, new[] { new BenchmarkBuildInfo(benchmark, ManualConfig.CreateEmpty().CreateImmutableConfig(), 0) }, BenchmarkRunnerClean.DefaultResolver)));
        }
        ...
        public void UsingStatementsInTheAutoGeneratedCodeAreProhibited()
        {
            ...
            var generatedSourceFile = CodeGenerator.Generate(new BuildPartition(0, new[] { new BenchmarkBuildInfo(benchmark, ManualConfig.CreateEmpty().CreateImmutableConfig(), 0) }, BenchmarkRunnerClean.DefaultResolver));
