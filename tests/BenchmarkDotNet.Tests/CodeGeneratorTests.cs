...
namespace BenchmarkDotNet.Tests
{
    public class CodeGeneratorTests
    {
        ...
        public void AsyncVoidIsNotSupported()
        {
            ...
            Assert.Throws<NotSupportedException>(() => CodeGenerator.Generate(new BuildPartition(new[] { new BenchmarkBuildInfo(benchmark, ManualConfig.CreateEmpty().CreateImmutableConfig(), 0) }, BenchmarkRunner.DefaultResolver)));
        }
        ...
        public void UsingStatementsInTheAutoGeneratedCodeAreProhibited()
        {
            ...
            var generatedSourceFile = CodeGenerator.Generate(new BuildPartition(new[] { new BenchmarkBuildInfo(benchmark, ManualConfig.CreateEmpty().CreateImmutableConfig(), 0) }, BenchmarkRunner.DefaultResolver));
