...
namespace BenchmarkDotNet.Tests.Analysers
{
    public class ZeroMeasurementHelperTests
    {
        ...
        */
        ...
        public void CheckZeroMeasurement_OneSample_Around_One_CPU_Cycle_Method(params double[] distribution)
        {
        ...
        public void CheckZeroMeasurement_OneSample_Exactly_One_CPU_Cycle_Method(params double[] distribution)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementOneSample(distribution, ThresholdMock);
            Assert.False(zeroMeasurement);
        }
        ...
        */
        ...
        public void CheckZeroMeasurement_OneSample_Less_Than_One_CPU_Cycle_Method(params double[] distribution)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementOneSample(distribution, ThresholdMock);
        ...
        */
        ...
        public void CheckZeroMeasurement_OneSample_Exactly_Zero_ns_Method(params double[] distribution)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementOneSample(distribution, ThresholdMock);
            Assert.True(zeroMeasurement);
        }
        ...
        */
        ...
        public void CheckZeroMeasurement_OneSample_Around_Two_CPU_Cycle_Method(params double[] distribution)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementOneSample(distribution, ThresholdMock);
            Assert.False(zeroMeasurement);
        }
        ...
        */
        ...
        public void CheckZeroMeasurement_TwoSamples_Less_Than_One_CPU_Cycle_Method(double[] workload, double[] overhead)
        {
        ...
        */
        ...
        public void CheckZeroMeasurement_TwoSamples_Around_One_CPU_Cycle_Method(double[] workload, double[] overhead)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementTwoSamples(workload, overhead);
            Assert.False(zeroMeasurement);
        }
        ...
        */
        ...
        public void CheckZeroMeasurement_TwoSamples_Around_Two_CPU_Cycle_Method(double[] workload, double[] overhead)
        {
            var zeroMeasurement = ZeroMeasurementHelper.CheckZeroMeasurementTwoSamples(workload, overhead);
            Assert.False(zeroMeasurement);
        }
