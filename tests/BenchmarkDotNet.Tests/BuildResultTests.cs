...
namespace BenchmarkDotNet.Tests
{
    public class BuildResultTests
    {
        ...
        {
            const string msbuildError = @"C:\...\gen.cs(157,125): error CS0234: The type or namespace name 'Diagnosers' does not exist in the namespace 'SomeCustom' (are you missing an assembly reference?) [C:\...\gen.csproj]";
        ...
        public void MissingBenchmarkDotNetReferenceIsTranslatedToMoreUserFriendlyVersion()
        {
            ...
            const string msbuildError = @"C:\...\gen.cs(10,20): error CS0400: The type or namespace name 'Perfolizer' could not be found in the global namespace (are you missing an assembly reference?) [C:\...\gen.csproj]";
        ...
        public void MissingValueTaskReferenceIsTranslatedToMoreUserFriendlyVersion()
        {
            ...
            const string msbuildError = @"C:\...\gen.cs(1,1): error CS0234: The type or namespace name 'ValueTask<>' does not exist in the namespace 'System.Threading.Tasks' (are you missing an assembly reference?) [C:\...\gen.csproj]";
