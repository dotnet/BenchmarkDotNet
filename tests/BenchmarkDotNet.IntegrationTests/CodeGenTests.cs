...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
    public class BenchmarkManyTypes
    {
        ...
        {
            var benchmarkType = new StackTrace(2, false).GetFrame(0).GetMethod().DeclaringType;
            Assert.StartsWith("Runnable_", benchmarkType.Name);
            AssertMethodsAggressivelyOptimized(benchmarkType);
