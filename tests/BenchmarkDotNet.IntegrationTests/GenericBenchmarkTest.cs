...
namespace BenchmarkDotNet.IntegrationTests
{
    ...
    public abstract class AbstractBenchmark<T>
    {
        ...
        {
            Thread.Sleep(10);
            // Our direct type is BenchmarkDotNet.IntegrationTests.FlatClassBenchmark
            // which instanced in BenchmarkDotNet.Autogenerated.Program,
            Console.WriteLine($"// ### Benchmark: SerializationLibrary1, Type: {GetType().GetTypeInfo().Name} ###");
        ...
        public void SerializationLibrary2()
        {
            ...
            // Our direct type is BenchmarkDotNet.IntegrationTests.FlatClassBenchmark
            // which instanced in BenchmarkDotNet.Autogenerated.Program,
            Console.WriteLine($"// ### Benchmark: SerializationLibrary2, Type: {GetType().GetTypeInfo().Name} ###");
