...
namespace BenchmarkDotNet.IntegrationTests.InProcess.EmitTests
{
    ...
    public class RunnableRefStructCaseBenchmark
    {
        ...
        [Benchmark, Arguments(new[] { 0, 1, 2 }, "1", 0.1)]
        public static Span<int> StaticRefStructCase1(Span<int> x, ref string y, double? z) => x;
        ...
        [Benchmark, Arguments(new[] { "A", "B", "C" }, "2", 0.2)]
        public static ReadOnlySpan<string> StaticRefStructCase2(ReadOnlySpan<string> x, ref string y, double? z) => x;
        ...
        [Benchmark, Arguments(new[] { 0, 1, 2 }, "3", 0.3)]
        public static Memory<int> StaticRefStructCase3(Memory<int> x, ref string y, double? z) => x;
        ...
        [Benchmark, Arguments(new[] { "A", "B", "C" }, "4", 0.4)]
        public static ReadOnlyMemory<string> StaticRefStructCase4(ReadOnlyMemory<string> x, ref string y, double? z) => x;
