...
namespace BenchmarkDotNet.Toolchains.Dnx
{
    public class DnxBuilder : IBuilder
    {
        ...
        public BuildResult Build(GenerateResult generateResult, ILogger logger)
        {
            ...
            return new BuildResult(generateResult, true, null, BuildExecutablePath(generateResult));
        }
        ...
        /// </summary>
        private string BuildExecutablePath(GenerateResult generateResult)
            => Path.Combine(
                generateResult.DirectoryPath, $"bin\\{Configuration}\\{Framework}", $"{DnxGenerator.AutogeneratedName}.exe");
    }
}